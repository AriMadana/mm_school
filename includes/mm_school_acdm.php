...
class MM_School_Acdm extends Db_object {

	protected static $db_table = "eth_acdm";
	protected static $db_fields = array('acdm_id', 'acdm_year_from', 'acdm_year_to', 'acdm_school');

	public $acdm_id;
	public $acdm_year_from;
	public $acdm_year_to;
	public $acdm_school;

  public function selectAcdm($school_id) {
    $db_table = static::$db_table;
    $result = $this -> find_array_by_query("SELECT * FROM `$db_table` WHERE `acdm_school` = '$school_id';");
    return $result;
  }
  public function addAcdm($acdm_year_from, $acdm_year_to, $school_id) {
    global $database;
    $db_table = static::$db_table;
    $acdm_year_from = $database -> escape_string($acdm_year_from);
    $acdm_year_to = $database -> escape_string($acdm_year_to);
    $result = $this -> insert_query("INSERT INTO `$db_table` (`acdm_year_from`, `acdm_year_to`, `acdm_school`) VALUES ('$acdm_year_from', '$acdm_year_to', $school_id)");
    return $result;
  }
