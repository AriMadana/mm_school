...
try{ 	//if there is a cURL problem and the API call can't execute at all,
  ...
  $api_key = "M0aGrSqgKbVVQ1i2vFHzbZG3x1VUqQRi";
  $api_secret = "6BRLYxbZnXSAXXWO";
...
$fieldsListResponse = makeAPICall('GET', 								//verb
								  'https://api.awhere.com/v2/agronomics/fields/F-1234-14-B/agronomicvalues',	//URL
...
if($fieldsListStatusCode==200){  	// Code 200 means the request was successful
	...
	echo '<p>Request:</p><pre>GET https://api.awhere.com/v2/agronomics/fields/F-1234-14-B/agronomicvalues</pre>';
